...
一個對抗同溫層、促進異質觀點對話的去極化對話平台。

本專案已通過國科會大專學生研究計畫（計畫編號：115-2813-C-032-043-H），由五人團隊分工開發。此 repo 為系統設計文件與畫面說明，用於呈現整體專題架構，不含原始碼。
...
你會操控一個像素小人在地圖上自由走動，地圖依議題分成不同區域，走到哪就看到那個議題底下大家貼的想法。主要可以做這些事：

- **自由漫遊**：用像素分身在議題廣場上到處走、靠近別人看他們貼了什麼，像逛街一樣。
- **發表立場**：把自己對議題的想法貼在角色頭頂的泡泡上，路過的人都看得到。
- **一鍵表態**：對別人貼的內容，不用打字回覆，用五種表情標籤（支持、反對等）就能直覺快速表態。
- **熱門議題參考**：系統會用爬蟲去抓公共政策討論平台上正在被討論的熱門議題，當作大家發表時的題目參考，不用自己想。
- **匿名保護**：進去只能選系統給的基礎像素角色、隨機分配一個 ID，看不出你是誰、也連不到你的帳號，聊起來比較沒壓力。
